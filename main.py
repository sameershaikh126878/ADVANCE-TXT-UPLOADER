...
keyboard = InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton("🇮🇳ʙᴏᴛ ᴍᴀᴅᴇ ʙʏ🇮🇳" ,url=f"https://t.me/SAMEERJI091") ],
                    [
                    InlineKeyboardButton("🔔ᴜᴘᴅᴀᴛᴇ ᴄʜᴀɴɴᴇʟ🔔" ,url="https://t.me/SAMEERJI091") ],
                    [
                    InlineKeyboardButton("🦋ғᴏʟʟᴏᴡ ᴜs🦋" ,url="https://t.me/SAMEERJI091")                              
                ],           
            ]
      )
...
async def upload(bot: Client, m: Message):
    ...
    try:
        for i in range(count - 1, len(links)):
            ...
            #url = f"https://as-multiverse-b0b2769da88f.herokuapp.com/{id}/master.m3u8?token={raw_text4}"
            elif "d1d34p8vz63oiq" in url or "sec1.pw.live" in url:
             url = f"https://as-multiverse-b0b2769da88f.herokuapp.com/pw?url={url}&token={pw_token}"
