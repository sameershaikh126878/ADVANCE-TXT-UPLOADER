...
# Ask Doubt on telegram  @DOCTOR_ASP
...
SUDO_USERS = [ 7615363859,6947024366,8144269730,7341059064,6148865829,5817712634,1511257208]
...
`")
    ...
    try:
        ...
        # Check if the response status is OK
            ...
            # Remove the PDF file after sending
                    ...
                    Show = f"**🚨𝗗𝗢𝗪𝗡𝗟𝗢𝗔𝗗𝗜𝗡𝗚🚨**\n\n**📝ɴᴀᴍᴇ » ** `{name}\n\n🔗ᴛᴏᴛᴀʟ ᴜʀʟ » {len(links)}\n\n❄ǫᴜᴀʟɪᴛʏ » {res}`\n\n**🔗ᴜʀʟ » ** `{url}`\n\n🤖𝗕𝗢𝗧 𝗠𝗔𝗗𝗘 𝗕𝗬 ➤ @OCTOR_ASP\n\n😻 जिंदगी का दूसरा नाम प्यार 😻"
    ...
    #await m.reply_text("**✅  ꜱᴜᴄᴄᴇꜱꜱꜰᴜʟʟʏ ᴅᴏɴᴇ ✅**")
    await m.reply_text(f"`✨𝗕𝗔𝗧𝗖𝗛 𝗦𝗨𝗠𝗠𝗔𝗥𝗬✨\n\n"
                       ...
                       f"▬▬▬▬▬▬▬▬▬▬▬▬▬▬\n"
                       f"✅𝗦𝗧𝗔𝗧𝗨𝗦 » 𝗖𝗢𝗠𝗣𝗟𝗘𝗧𝗘𝗗`")
    await m.reply_text(f"<pre><code>⬇️ 𝔻𝕆𝕎ℕ𝕃𝕆𝔸𝔻 𝔹𝕐 ➤『{raw_text3}』</code></pre>")
    await m.reply_text(f"<pre><code>『🦋 जिंदगी का दूसरा नाम प्यार 🦋』</code></pre>")                 
